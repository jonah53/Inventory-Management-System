<?php
  ...
  $sql = "SELECT User_ID, Surname, Name FROM users WHERE Username = '".$username."'";
              ...
              <div class="col-md-12 col-sm-12 col-xs-12">
                <div class="x_panel">
                  ...
                  <div class="x_content">
                    ...
                    <span class="section"> Requisition </span>
					<div class="row col-md-12 col-sm-12 col-xs-12">
						<div class="row col-md-6 col-sm-6 col-xs-12">
							<div class="item form-group">
								<label class="control-label col-md-4 col-sm-4 col-xs-12" for="telephone">Item	</label>
						...
						<div class="row col-md-6 col-sm-6 col-xs-12">
							<div class="item form-group">
								<label class="control-label col-md-4 col-sm-4 col-xs-12" for="telephone">Quantity	</label>
								<div class="col-md-8 col-sm-8 col-xs-12">
									<input type="text" id="origin" name="origin" class="form-control col-md-7 col-xs-12">
								</div>
							</div>
                      ...
                      <div class="form-group">
                        <div class="col-md-6 col-md-offset-0">
                          <input type="submit" class="btn btn-success submit" value="Add Items">
                        </div>
                      </div>
                    </form>
